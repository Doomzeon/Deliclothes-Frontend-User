...
class CreditCard {
  String number, card_type, owner;
  int month, year, cvv;

  CreditCard();

  /*static CreditCard fromJson(dynamic data) {
      print(data);
    return CreditCard(
      ...
      data['id_stripe'] as String,
      data['expiration_month'] as int,
      data['expiration_year'] as int,
      data['cvc'] as int,
      data['id'] as int
    );
  }*/
...
class PaymentCardD {
  ...
  PaymentCardD(this.type, this.number, this.name, this.month, this.year,
      this.cvv, this.owner);
}
